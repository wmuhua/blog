...
toc: false
mathjax: false
summary: 本文主要记录Vue2和Vue3的组件通信方式用法整理总结
categories: Vue
tags:
  - Vue
  - 组件通信
...
Vuex 是状态管理器，集中式存储管理所有组件的状态。这一块内容过长，如果基础不熟的话可以看这个[Vuex](https://vuex.vuejs.org/zh/)，然后大致用法如下

比如创建这样的文件结构

![微信图片_20210824003500.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a2f14ac26fad4d2b8fdba288865c2916~tplv-k3u1fbpfcp-watermark.image)
